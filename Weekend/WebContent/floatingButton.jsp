...
<script type='text/javascript'>
	...
	function shareFB()
	{
		...
		window
				.open('https://www.facebook.com/sharer/sharer.php?u=http://winbo121.cafe24.com/Weekend/main.jsp');
...
<div class="flBtn flBtn-position-br flBtn-size-medium">
	...
	<li><a id="kakao-link-btn" href="javascript:sendLink()" tooltip="kakao"> <img
		src="Weekend/css/images/kakao-talk.svg" style="width: 20px; height: 40px;"></a></li>
		...
		<li><a href="javascript:void(0);" onclick="share_band('주말플러스', 'http://winbo121.cafe24.com/Weekend/main.jsp');return false;" tooltip="Band"><img
